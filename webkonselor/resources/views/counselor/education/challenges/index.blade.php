                    ...
                    <tr>
                        <td>
                            <div style="display: flex; align-items: center; gap: 16px;">
                                <div style="width: 54px; height: 54px; border-radius: 10px; background: #f1f5f9; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; border: 1px solid var(--border);">🏆</div>
                                <div>
                                    <div style="font-weight: 600; color: var(--text-1); font-size: 1rem;">{{ $c->title }}</div>
                                    <div style="font-size: 0.8rem; color: var(--text-3); margin-top: 2px;">{{ Str::limit($c->description, 60) }}</div>
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td style="font-family: 'Outfit', sans-serif; font-weight: 700; color: var(--accent);">{{ $c->reward_point }}</td>
                        <td>
                            <div class="actions">
